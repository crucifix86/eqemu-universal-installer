...
if ($status >= 80 && $text=~/We shall never surrender/i) {
	...
	quest::spawn2 (56173,0,0,700,-1224.3,-107.9,125.4); # NPC: #a_minion_of_Meldrath
	quest::spawn2 (56173,0,0,650,-1224.3,-108.9,125.4); # NPC: #a_minion_of_Meldrath
	quest::spawn2 (56173,0,0,600,-1224.3,-108.9,125.4); # NPC: #a_minion_of_Meldrath
	quest::spawn2 (56173,0,0,550,-1224.3,-107.9,125.4); # NPC: #a_minion_of_Meldrath
	quest::spawn2 (56173,0,0,500,-1224.3,-107.9,125.4); # NPC: #a_minion_of_Meldrath
	quest::spawn2 (56173,0,0,450,-1224.3,-107.9,125.4); # NPC: #a_minion_of_Meldrath
	}
...
if ($entitylist -> GetMobByNpcTypeId(56173) == undef){
	...
	quest::spawn2 (56174,0,0,700,-1224.3,-107.9,125.4); # NPC: #Meldrath`s_melded_minions
	quest::spawn2 (56174,0,0,600,-1224.3,-108.9,125.4); # NPC: #Meldrath`s_melded_minions
	quest::spawn2 (56174,0,0,450,-1224.3,-107.9,125.4); # NPC: #Meldrath`s_melded_minions
	}
}
...
if ($entitylist -> GetMobByNpcTypeId(16174) == undef){
	quest::spawn2 (56175,0,0,600,-1224.3,-108.9,125.4); # NPC: #Arnold_the_Gnomeinator
